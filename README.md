...
1. יש לוודא כי מותקנת גרסה עדכנית של Python (גרסה 3.8 ומעלה).
...
3. יש להפעיל את מסד הנתונים PostgreSQL ולוודא כי קיימות בו הטבלאות הדרושות, בהתאם לסכמת המערכת (Staff, Driver, Schedule, Attendance, Salary, DriverAssignment,DriverLicense)

4. יש לפתוח את הקובץ הראשי main.py ולהריץ את הקוד, למשל באמצעות שורת הפקודה:

python main.py

5. לאחר התחברות מוצלחת למסד הנתונים – ייפתח הממשק הגרפי של המערכת, ממנו ניתן לגשת לכל רכיבי הניהול.
